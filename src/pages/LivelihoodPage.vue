          ...
          <div class="main">
            <div class="card story" style="text-align: justify">
              ...
              <p class="lead" style="text-align: justify">
                <strong
                  >Imagine having the will to work and the dream of a better
                  life, but no opportunity to make it happen.</strong
                >
                This is the daily reality for millions trapped by poverty,
                unemployment, and financial exclusion.
              </p>

              <p style="text-align: justify">
                At <strong class="brand">Lorena Foundation</strong>, our
              ...
              <div class="callout" style="text-align: justify">
                <p class="callout-title">
                  Unlocking potential, restoring hope.
                </p>
                <p>
...
const reloadData = () => {
  fetchCampaign("livelihood-economic");
};
