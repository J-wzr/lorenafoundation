          ...
          <div class="main">
            <div class="card story" style="text-align: justify">
              ...
              <p class="headline" style="text-align: right">
                <strong
                  >Protect the Planet. Empower Communities. Transform the
                  Future.</strong
                >
              </p>
              ...
              <p style="text-align: justify">
                At <strong class="brand">Lorena Foundation</strong>, we empower
                communities to protect the planet and build sustainable futures.
                Our programs include reforestation and renewable energy
                initiatives, sustainable agriculture, waste management, and
                environmental education.
              </p>

              <div class="callout" style="text-align: justify">
                <p class="callout-title">Climate action at every level.</p>
                <p>
                  We integrate environmental care into community development,
                  helping people not only adapt to climate change but actively
                  work to reverse it.
                </p>
              </div>

              <p class="conclusion" style="text-align: justify">
                Together, we can restore ecosystems, strengthen livelihoods, and
                leave a greener, healthier world for generations to come.
              </p>
            </div>
          </div>
        </div>
        ...
        <div class="next-campaign-section">
          <div class="next-campaign-left">
            ...
            <q-btn
              ...
              class="next-btn"
              to="/livelihood-and-economic-inclusion"
            />
          </div>
          <div class="next-campaign-right">
            <div
              class="campaign-preview-card q-hover-shadow cursor-pointer"
              @click="$router.push('/livelihood-and-economic-inclusion')"
              v-ripple
            >
