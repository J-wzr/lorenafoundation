  ...
  <q-page class="wash-page">
    ...
    <section class="hero">
      ...
      <div class="positioned-titles">
        <p class="positioned-subtitle">Community Health</p>
      </div>
    </section>
          ...
          <div class="main">
            <div class="card story" style="text-align: justify">
              ...
              <p class="headline" style="text-align: right">
                <strong>Health is Not a Privilege. It's a Human Right.</strong>
              </p>

              <p class="lead" style="text-align: justify">
                <strong
                  >A mother loses her child to malaria. A family walks for hours
                  to reach the nearest clinic.</strong
                >
                A community faces an outbreak, with no medicine, no answers.
              </p>

              <p style="text-align: justify">
                These tragedies are preventable. That's why the
                <strong class="brand">Lorena Foundation</strong> is taking
                action.
              </p>

              <div class="callout" style="text-align: justify">
                <p class="callout-title">
                  Through the Community Health work, we:
                </p>
                <p>
                  Support rural clinics and train local health workers,
                  prioritize maternal and child health, nutrition, and disease
                  prevention and lead hygiene and wellness education campaigns.
                </p>
              </div>

              <p style="text-align: justify">
                We don't just treat illness, we prevent it. Because when
                communities are healthy, they thrive, children grow stronger,
                and families can live with dignity.
              </p>

              <p class="conclusion" style="text-align: justify">
                Join us in building a world where no one is left behind.
              </p>
            </div>
          </div>
        </div>
        ...
        <div class="next-campaign-section">
          ...
          <div class="next-campaign-right">
            <div
              ...
              @click="$router.push('/education-for-all')"
              v-ripple
            >
...
const reloadData = () => {
  fetchCampaign("community-health");
};
...
.hero-bg {
  ...
  right: 0;
  bottom: 0;
  background: url("/doctor_patient.jpg") center/cover;
