      ...
      <div class="container container-head">
          ...
          <div class="main">
            <div class="card story" style="text-align: justify">
              ...
              <p class="headline" style="text-align: right">
                <strong>Give Water. Give Life. Transform a Future.</strong>
              </p>

              <p class="lead" style="text-align: justify">
                <strong
                  >A little girl walks miles every day in search of
                  water.</strong
                >
                She is not alone. Millions of children and mothers face the same
                journey, relying on unsafe water and living at constant risk of
                deadly disease.
              </p>
              ...
              <div class="callout" style="text-align: justify">
                <p class="callout-title">Clean water is more than a drink.</p>
                <p>
                  It keeps children in school, protects mothers' health, and
                  helps families break cycles of poverty and disease.
                </p>
              </div>
        ...
        <div class="next-campaign-section">
          <div class="next-campaign-left">
            ...
            <!-- Small line for top campaign -->
            <p class="top-campaign-summary" v-if="topCampaign">
              Most Supported:
              <router-link
                :to="`/campaign/${topCampaign.id}`"
          ...
          <div class="next-campaign-right">
            <div
              ...
              @click="$router.push('/community-health')"
              v-ripple
            >
...
const { topCampaign, fetchTopCampaign } = useCampaigns();
