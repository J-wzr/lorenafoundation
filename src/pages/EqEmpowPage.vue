  ...
  <q-page class="wash-page">
    ...
    <section class="hero">
      ...
      <div class="positioned-titles">
        <p class="positioned-subtitle">Equality & Empowerment</p>
      </div>
    </section>
          ...
          <div class="main">
            <div class="card story" style="text-align: justify">
              ...
              <p class="headline" style="text-align: right">
                <strong>Lift Voices. Break Chains. Empower Futures.</strong>
              </p>

              <p class="lead" style="text-align: justify">
                <strong>Everybody has a dream. Everyone has a voice.</strong>
                Yet too many are silenced.
              </p>

              <p style="text-align: justify">
                Millions, especially women and girls, face barriers to
                education, healthcare, employment, and leadership. Cultural
                norms and gender-based violence often hold them back.
              </p>
              ...
              <div class="callout" style="text-align: justify">
                <p class="callout-title">Every empowered person is a spark.</p>
                <p>
                  A leader waiting to rise. A change-maker ready to inspire.
                  With your support, they can ignite transformation in their
                  communities.
                </p>
              </div>
        ...
        <div class="next-campaign-section">
          ...
          <div class="next-campaign-right">
            <div
              ...
              @click="$router.push('/green-transformation')"
              v-ripple
            >
...
const reloadData = () => {
  fetchCampaign("equality-empowerment");
};
